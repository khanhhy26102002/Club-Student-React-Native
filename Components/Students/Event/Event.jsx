...
import Header from "../../../Header/Header"; // Giữ lại Header của bạn
import { fetchBaseResponse } from "../../../utils/api";
import { useFocusEffect } from "@react-navigation/native";
import AsyncStorage from "@react-native-async-storage/async-storage";

// Một URL ảnh placeholder đẹp hơn, bạn có thể thay đổi
const DEFAULT_EVENT_IMAGE = "https://images.unsplash.com/photo-1505238680356-667803448bb6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80";
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.noEventSubText}>Hãy quay lại sau để cập nhật các sự kiện mới nhất nhé!</Text>
          </View>
        ) : (
          data.map((event) => {
